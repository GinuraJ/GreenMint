            ...
            <div className="treeRepoLeft">
                ...
                <div className="contentArea">
                    ...
                    <div className="inputArea grid grid-cols-2">
                        ...
                        <label for="price" class="block text-sm/6 font-medium text-gray-900">Diameter / Width</label>
                                <div class="mt-2">
                                    <div class="flex items-center rounded-md bg-white pl-3 
                                        outline outline-1 
                                        -outline-offset-1 
                            ...
                            <label for="price" class="block text-sm/6 font-medium text-gray-900 mt-7">Height</label>
                            <div class="mt-2">
                                <div class="flex items-center rounded-md bg-white pl-3 
                                    outline outline-1 
                                    -outline-offset-1 
                            ...
                            <label for="price" class="block text-sm/6 font-medium text-gray-900 mt-7">Don not Upload a tree image</label>
